...
function User() {
  ...
  const {searchSingleUser, user, loading, getUserRepos, repos } = useContext(GitHubContext)
            ...
            {blog && (
              <div className="stat">
                ...
                <div className="text-lg stat-value">
                  <a href={`https://${blog}`} target='_blank' rel="noreffer">{blog}</a>
                </div>
              </div>
            )}
            {twitter_username && (
              <div className="stat">
                ...
                <div className="text-lg stat-value">
                  <a href={`https://twitter.com/${twitter_username}`} target='_blank' rel="noreffer">{blog}</a>
                </div>
              </div>
            )}
          </div>
